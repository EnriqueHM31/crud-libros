        ...
        <div className="flex flex-col items-center justify-between md:flex-row">
            ...
            <div className="flex-1">
                <motion.button
                    ...
                    className="bg-primary text-background hover:bg-primary mt-5 flex w-full cursor-pointer items-center justify-center gap-3 rounded-xl px-4 py-2 font-semibold transition-colors duration-150 md:mt-0 md:py-2.5 dark:bg-blue-600 dark:hover:bg-blue-800"
                >
