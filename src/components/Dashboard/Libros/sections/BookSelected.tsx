        ...
        <AnimatePresence>
            {isModalOpen && (
                ...
                >
                    {/* MODAL */}
                    <motion.div
                        className="dark:bg-primary-dark relative flex h-full max-h-[90dvh] w-full max-w-10/12 flex-col justify-between overflow-y-auto rounded-2xl border border-gray-700 bg-white px-4 py-3 shadow-xl md:max-h-fit md:max-w-3xl md:p-8"
