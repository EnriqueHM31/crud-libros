        ...
        <div className="flex flex-col items-center justify-between md:flex-row">
            ...
            <div className="flex w-fit flex-2 items-center justify-end">
                <motion.button
                    ...
                    className="bg-primary flex w-fit cursor-pointer items-center justify-center gap-3 rounded-xl px-4 py-2 font-semibold text-white transition-colors duration-150 hover:bg-blue-800 md:mt-0 md:py-2.5 dark:bg-blue-600"
                >
