                ...
                <div className="group relative flex items-center justify-between gap-6 pb-3">
                    ...
                    <div className="flex  items-center justify-end">
                        <motion.button
                            ...
                            className="bg-primary text-background hover:bg-primary flex w-fit cursor-pointer items-center justify-center gap-3 rounded-xl px-4 py-2.5 font-semibold transition-colors duration-150 dark:bg-blue-600 dark:hover:bg-blue-800"
                        >
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="group relative">
                        ...
                        <div className="pointer-events-none absolute top-1/2 right-3 -translate-y-1/2">
                            <svg
                                className="text-text-secondary/80 h-4 w-4 group-hover:text-gray-600 dark:text-gray-600"
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                            >
                    ...
                    <div className="group relative">
                        ...
                        <input
                            ...
                            className="dark:bg-primary-dark w-full rounded-xl border-2 border-gray-300 bg-white py-3 pr-4 pl-10 text-sm text-black shadow-sm transition-all hover:shadow-md focus:ring-1 focus:ring-gray-600 focus:outline-none dark:border-gray-600 dark:text-white dark:focus:ring-gray-400"
                        />
                    </div>
