...
export default function HeaderTypeFormatBook({ viewMode, handleViewMode }: HeaderTypeFormatBookProps) {
    ...
    return (
        <div className="flex items-center  w-full  justify-between md:flex-row my-6 md:mt-0">
            <h2 className="my-0 md:my-10 text-3xl font-bold text-black dark:text-white">Libros</h2>

            <div className="flex items-center gap-2 justify-end  w-full">
                <span className="md:me-10 text-sm font-medium text-gray-500 dark:text-gray-400 order-2 md:order-1">Mostrando {total} libros</span>
