            ...
            <div className="flex items-center justify-between gap-3  pb-4 border-b border-background-secondary">
                ...
                <div className="mt-6 flex justify-end">
                    <button
                        ...
                        className="flex items-center gap-2 rounded-xl px-5 py-2.5 text-sm font-medium text-secondary hover:text-primary hover:bg-blue-50 border-2 border-transparent hover:border-blue-200 transition-all duration-200 group cursor-pointer"
                    >
